					...
					<div class="card-body">
						<form method="POST" action="{{ route('member.store') }}" aria-label="{{ __('Member') }}">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="business_location" type="text" class="form-control{{ $errors->has('business_location') ? ' is-invalid' : '' }}" name="business_location"
										   value="{{ old('business_location') }}" required autofocus>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<select id="subscription_mode" type="text" class="form-control{{ $errors->has('subscription_mode') ? ' is-invalid' : '' }}" name="subscription_mode" required
											autofocus>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<select id="annually_subscription_rates" type="text" class="form-control{{ $errors->has('annually_subscription_rates') ? ' is-invalid' : '' }}"
										...
										<option value="Artisans12,000">Artisans 12,0000</option>
							...
							<div class="form-group row">
								<label for="rc_number" class="col-md-4 col-form-label text-md-right">{{ __('rc number (if available)') }}</label>

								<div class="col-md-6">
									<input id="rc_number" type="text" class="form-control{{ $errors->has('rc_number') ? ' is-invalid' : '' }}"
							...
							<div class="form-group row">
								<label for="name_of_care_group_leader" class="col-md-4 col-form-label text-md-right">{{ __('Name of care group leader') }}</label>

								<div class="col-md-6">
									<input id="name_of_care_group_leader" type="text" class="form-control{{ $errors->has('name_of_care_group_leader') ? ' is-invalid' : '' }}"
										   name="name_of_care_group_leader" value="{{ old('name_of_care_group_leader') }}" required autofocus>
							...
							<div class="form-group row">
								<label for="care_group" class="col-md-4 col-form-label text-md-right">{{ __('care group') }}</label>

								<div class="col-md-6">
									<input id="care_group" type="text" class="form-control{{ $errors->has('care_group') ? ' is-invalid' : '' }}" name="care_group"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="telephone" type="tel" class="form-control{{ $errors->has('telephone') ? ' is-invalid' : '' }}"
